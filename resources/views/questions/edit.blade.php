                            ...
                            {!! Form::open(['route' => ['web.questions.update', $question->id], 'method' => 'PUT']) !!}
                                <div class="row">
                                    <div class="form-group col-9">
                                        ...
                                        {{ Form::select('question_type_id', \App\Entities\QuestionType::all(['id', 'name'])->pluck('name', 'id')->toArray(), $question->question_type_id, ['placeholder' => 'Pick a type...', 'class' => 'form-control form-control-alternative']) }}
                                    </div>
