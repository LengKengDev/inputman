...
! function(n) {
  ...
  w.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", w.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", w.FE.LinkRegExTLD = "((" + w.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", w.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + w.FE.LinkRegExCommon + ")", w.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + w.FE.LinkRegExCommon + ")", w.FE.LinkRegExWWW = "(www\\." + w.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", w.FE.LinkRegEx = "(" + w.FE.LinkRegExTLD + "|" + w.FE.LinkRegExHTTP + "|" + w.FE.LinkRegExWWW + "|" + w.FE.LinkRegExAuth + ")" + w.FE.LinkRegExEnd, w.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], w.FE.MAIL_REGEX = /.+@.+\..+/i, w.FE.MODULES.helpers = function(i) {
    ...
    function n(e) {
      ...
      if (!l.core.hasFocus() && e) {
        ...
        if (l.browser.msie && l.$box && l.$box.css("position", "fixed"), l.browser.msie && l.$wp && l.$wp.css("overflow", "visible"), i(), l.$el.focus(), l.events.trigger("focus"), o(), l.browser.msie && l.$box && l.$box.css("position", ""), l.browser.msie && l.$wp && l.$wp.css("overflow", "auto"), t != l.$win.scrollTop() && l.$win.scrollTop(t), !l.selection.info(l.el).atStart) return !1
      }
      ...
      if (l.selection.info(l.el).atStart && l.selection.isCollapsed() && null != l.html.defaultTag()) {
        ...
        if (n && !l.node.blockParent(n)) {
          ...
          r && (w(r).prepend(w.FE.MARKERS), l.selection.restore())
        } else n && w(n).remove()
      }
    }
    var r = !1;
    ...
    function f(e, t, n, r, o) {
      ...
      var i, a = o ? l.shared.$_events : c,
        s = o ? l.sid : l.id;
      i = r, r = function() {
        l.destroying || i.apply(this, arguments)
    ...
    return {
      _init: function() {
        l.shared.$_events = l.shared.$_events || [], l.shared._events = {}, l.helpers.isMobile() ? (l._mousedown = "touchstart", l._mouseup = "touchend", l._move = "touchmove", l._mousemove = "touchmove") : (l._mousedown = "mousedown", l._mouseup = "mouseup", l._move = "", l._mousemove = "mousemove"), t(l.$el, "click mouseup mousedown touchstart touchend dragenter dragover dragleave dragend drop dragstart", function(e) {
          ...
          r = !1
        }), o(), t(l.$el, "cut copy paste beforepaste", function(e) {
          u(e.type, [e])
      ...
      bindClick: function(e, t, n) {
        f(e, l._mousedown, t, function(e) {
          ...
          l.edit.isDisabled() || (e.find(t).removeClass("fr-selected"), o())
      ...
      place: function(e, t, n) {
        ...
        try {
          ...
          if (!1 === t && !e.collapsed) {
            ...
            r.parentNode && 0 <= ["TD", "TH"].indexOf(r.parentNode.tagName) && r.parentNode.previousSibling && !r.previousSibling && w(r.parentNode.previousSibling).append(r)
          }
    ...
    function i(e, t) {
      ...
      r.setAttribute("id", "fr-sel-markers"), r.innerHTML = w.FE.MARKERS, e.appendChild(r);
    ...
    function v(e) {
      ...
      ! function(e) {
        ...
        if (e.nodeType == Node.ELEMENT_NODE && w.FE.HTML5Map[e.tagName] && "" === c.node.attributes(e)) {
    ...
    return {
      _init: function() {
        c.opts.fullPage && w.merge(c.opts.htmlAllowedTags, ["head", "title", "style", "link", "base", "body", "html", "meta"])
      },
      html: function(e, t, n, r) {
        void 0 === t && (t = []), void 0 === n && (n = []), void 0 === r && (r = !1);
        var o, i = w.merge([], c.opts.htmlAllowedTags);
        for (o = 0; o < t.length; o++) 0 <= i.indexOf(t[o]) && i.splice(i.indexOf(t[o]), 1);
        var a = w.merge([], c.opts.htmlAllowedAttrs);
      ...
      toHTML5: function() {
        var e = c.el.querySelectorAll(Object.keys(w.FE.HTML5Map).join(","));
        if (e.length) {
          var t = !1;
          c.el.querySelector(".fr-marker") || (c.selection.save(), t = !0);
          for (var n = 0; n < e.length; n++) "" === c.node.attributes(e[n]) && w(e[n]).replaceWith("<" + w.FE.HTML5Map[e[n].tagName] + ">" + e[n].innerHTML + "</" + w.FE.HTML5Map[e[n].tagName] + ">");
        ...
        ! function() {
          ...
          function() {
            for (var e = c.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++)
              for (var n = c.node.contents(e[t]), r = null, o = n.length - 1; 0 <= o; o--) "LI" != n[o].tagName && "UL" != n[o].tagName && "OL" != n[o].tagName ? (r || (r = w("<li>")).insertBefore(n[o]), r.prepend(n[o])) : r = null
          }(),
          function() {
            var e, t, n;
            do {
          ...
          function() {
            for (var e = c.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
              var n = e[t];
              if (c.node.isFirstSibling(n)) w(n).before("<br/>");
          ...
          function() {
            for (var e = c.el.querySelectorAll("li:empty"), t = 0; t < e.length; t++) w(e[t]).remove()
          }()
      },
    ...
    function r(e, t) {
      ...
      if (!l.html.isPreformatted(i)) {
        ...
        for (var a = "", s = 0; s < o.length; s++) 32 != o.charCodeAt(s) || 0 !== s && 32 != a.charCodeAt(s - 1) || n && r && l.node.isVoid(n) && l.node.isVoid(r) ? a += o[s] : a += w.FE.UNICODE_NBSP;
        (!r || r && l.node.isBlock(r) || r && r.nodeType == Node.ELEMENT_NODE && l.win.getComputedStyle(r) && "block" == l.win.getComputedStyle(r).display) && (a = a.replace(/ $/, w.FE.UNICODE_NBSP)), !n || l.node.isVoid(n) || l.node.isBlock(n) || 1 !== (a = a.replace(/^\u00A0([^ $])/, " $1")).length || 160 !== a.charCodeAt(0) || !r || l.node.isVoid(r) || l.node.isBlock(r) || (a = " "), t || (a = a.replace(/([^ \u00A0])\u00A0([^ \u00A0])/g, "$1 $2")), e.textContent != a && (e.textContent = a)
      }
    }
    ...
    return {
      ...
      insert: function(e, t, n) {
        var r, o, i;
        if (F.selection.isCollapsed() || F.selection.remove(), r = t ? e : F.clean.html(e), e.indexOf('class="fr-marker"') < 0 && (o = r, (i = F.doc.createElement("div")).innerHTML = o, F.selection.setAtEnd(i), r = i.innerHTML), F.node.isEmpty(F.el) && !F.opts.keepFormatOnDelete && f(r)) F.el.innerHTML = r;
        else {
  ...
  }), w.FE.MODULES.placeholder = function(c) {
    function e() {
      c.$placeholder || (c.$placeholder = w('<span class="fr-placeholder"></span>'), c.$wp.append(c.$placeholder));
      var e = c.opts.iframe ? c.$iframe.prev().outerHeight(!0) : c.$el.prev().outerHeight(!0),
        ...
        l = w(c.selection.element()).css("text-align");
    ...
    return {
      _init: function() {
        if (w.FE.INSTANCES.push(i), i.drag_support = {
      ...
      injectStyle: function(e) {
        if (i.opts.iframe) {
          ...
          for (var t = 0; t < i.opts.iframeStyleFiles.length; t++) {
            var n = w('<link data-fr-style="true" rel="stylesheet" href="' + i.opts.iframeStyleFiles[t] + '">');
    ...
    function n(e) {
      ...
      if (!u.node.isBlock(n) && u.node.isEditable(n)) {
        ...
        else if ((t = u.node.contents(n)) && "BR" == t[0].tagName && w(t[0]).remove(), t && "BLOCKQUOTE" == n.tagName) {
          var r = t[0];
    ...
    return {
      enter: function(t) {
        ...
        u.el.normalize();
        var r = !1;
        0 < w(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), w(n).parentsUntil(u.$el, "TD, TH").length && (r = !1), i(n) ? !s(n) || t || r ? p(n, t, r) : u.cursorLists._endEnter(n) : a(n) ? !s(n) || t || r ? function e(t, n, r) {
      ...
      backspace: function() {
        ...
        return i(t) ? e = c(t) : a(t) ? s(t) && g(t, w(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : function(e) {
          ...
          if (null !== n) {
            ...
            if (u.node.isBlock(n) && u.node.isEditable(n) && a && w.FE.NO_DELETE_TAGS.indexOf(a.tagName) < 0)
        ...
        for (var i = h.node.contents(t.get(0)), a = 0; a < i.length; a++) {
          ...
          if (h.node.hasClass(s, "fr-marker")) n = (n + 1) % 2;
            ...
            if (0 < w(s).find(".fr-marker").length) n = e(w(s), n, r, o);
              ...
              for (var l = w(s).find(r || "*:not(a):not(br)"), d = l.length - 1; 0 <= d; d--) {
                var c = l[d];
              ...
              void 0 === r && s.nodeType == Node.ELEMENT_NODE && !h.node.isVoid(s) || p(s, f(r, o)) ? h.node.isBlock(s) || w(s).replaceWith(s.innerHTML) : void 0 === r && s.nodeType == Node.ELEMENT_NODE && h.node.isBlock(s) && "TABLE" != s.tagName && h.node.clearAttributes(s)
      ...
      _init: function() {
        ...
        for (var n, r, o, i = !(p.ul = !0), a = 0, s = 0; s < e.length; s++) {
          ...
          if (d === v(h(v("mcVRDoB1BGILD7YFe1BTXBA7B6=="))) || 0 <= d.indexOf(g, d.length - g.length) || y(g)) {
            if (!((null === (n = l[1]) || new Date(n) < new Date(v("uB2C1D7B5E1E5E4A1E3C11=="))) && 0 < (g || "").length) || y(g)) {
              p.ul = !1;
              break
            }
    ...
    function e(e) {
      ...
      n(t, w("<div>").html(t).text()), "cut" == e.type && (b.undo.saveStep(), setTimeout(function() {
    ...
    function t(e) {
      ...
      return function() {
        b.selection.save(), b.events.disableBlur(), a = null, o ? (o.html(""), b.browser.edge && b.opts.iframe && b.$el.append(o)) : (o = w('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>'), b.browser.webkit ? (o.css("top", b.$sc.scrollTop()), b.$el.after(o)) : b.browser.edge && b.opts.iframe ? b.$el.append(o) : b.$box.after(o), b.events.on("destroy", function() {
          o.remove()
        }));
      ...
      if (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData) {
        ...
        if (a = "", /text\/rtf/.test(t) && (s = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? a = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && b.browser.safari ? a = s : /text\/plain/.test(t) && !this.browser.mozilla && (a = b.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== a) {
          ...
          if (b.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"), b.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"), b.selection.restore(), b.selection.remove(), b.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"), !1 !== o) {
            ...
            return w(i).replaceWith(w.FE.MARKERS), b.selection.restore(), l(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1
          }
        } else a = null
      }
    }
    ...
    function d(e, t, n) {
      ...
      if ("string" == typeof c && (e = c), "" !== e) {
        ...
        var g = b.selection.element(),
          h = !1;
        if (g && w(g).parentsUntil(b.el, "ul, ol").length && (h = !0), h) {
          var m = f.children;
        ...
        else if (b.opts.enter == w.FE.ENTER_DIV)
          for (r = (o = f.getElementsByTagName("p")).length - 1; 0 <= r; r--) 0 === (i = o[r]).attributes.length && (i.outerHTML = "<div>" + i.innerHTML + "</div>");
        else b.opts.enter == w.FE.ENTER_P && 1 == f.childNodes.length && "P" == f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
        e = f.innerHTML, l && (e = function(e) {
          var t, n = b.o_doc.createElement("div");
          n.innerHTML = e;
          var r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + w.FE.VOID_ELEMENTS.join("):not(") + "):not(" + b.opts.htmlAllowedEmptyTags.join("):not(") + ")");
          for (; r.length;) {
            for (t = 0; t < r.length; t++) r[t].parentNode.removeChild(r[t]);
            r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + w.FE.VOID_ELEMENTS.join("):not(") + "):not(" + b.opts.htmlAllowedEmptyTags.join("):not(") + ")")
          }
          return n.innerHTML
        }(e)), b.html.insert(e, !0)
      }
    ...
    function i(e, t) {
      ...
      n < 0 && (n = 0), n + o.$tooltip.outerWidth() > w(o.o_win).width() && (n = w(o.o_win).width() - o.$tooltip.outerWidth()), void 0 === t && (t = o.opts.toolbarBottom);
  ...
  }, w.FE.MODULES.position = function(E) {
    function o() {
    ...
    function n(e) {
      ...
      } else clearTimeout(w(e).css("sticky-timeout")), n.css("top", "0"), n.css("position", ""), n.width(""), n.data("sticky-top", 0), n.removeClass("fr-sticky-on"), E.$box.removeClass("fr-sticky-box")
    }
    ...
    function t(e) {
      if (e.offsetWidth) {
        var t, n, r = w(e),
          ...
          a = w("body" == E.opts.scrollableContainer ? E.o_win : E.opts.scrollableContainer).outerHeight(),
          s = 0,
          l = 0;
        "body" !== E.opts.scrollableContainer && (s = E.$sc.offset().top, l = w(E.o_win).outerHeight() - s - a);
      ...
      _init: function() {
        ! function() {
          if (E._stickyElements = [], E.helpers.isIOS()) {
            ...
            t(), E.events.$on(w(E.o_win), "scroll", function() {
              if (E.core.hasFocus())
                for (var e = 0; e < E._stickyElements.length; e++) {
                  var t = w(E._stickyElements[e]),
                    n = t.parent(),
                    r = E.helpers.scrollTop();
                  t.outerHeight() < r - n.offset().top && (t.addClass("fr-opacity-0"), t.data("sticky-top", -1), t.data("sticky-scheduled", -1))
                }
            }, !0)
          } else "body" !== E.opts.scrollableContainer && E.events.$on(w(E.opts.scrollableContainer), "scroll", e, !0), E.events.$on(w(E.o_win), "scroll", e, !0), E.events.$on(w(E.o_win), "resize", e, !0), E.events.on("initialized", e), E.events.on("focus", e), E.events.$on(w(E.o_win), "resize", "textarea", e, !0);
